...
// console.log(
// 	orders.filter((order) => order.orderId === "234" && !order.delivered)
// );
...
// console.log(orders.filter(delivered => !delivered.delivered ))
// console.log(orders.every((order) => order.delivered));

// 4) Has the customer with ID '123' made any orders?
// console.log(orders.some((x) => x.customerId === "123"));
// console.log(orders.filter((x) => x.customerId === "123"));
